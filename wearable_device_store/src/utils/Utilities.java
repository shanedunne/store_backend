...
/**
 * A class that provides some reusable utilities for the project
 */
public class Utilities {
    ...
    /**
     * This method returns a string truncated to the length specified.
     *
     * @param stringToTruncate the string that should be truncated.
     * @param length           the length to truncate to.
     * @return the truncated string or null if no string passed as a param.
     */
    ...
    /**
     * This method returns true of the index is valiid in the provided List.
     *
     * @param list         the list to check for the provided index.
     * @param indexToCheck the index to look for.
